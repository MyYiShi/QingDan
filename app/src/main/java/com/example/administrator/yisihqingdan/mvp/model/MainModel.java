...
public class MainModel implements MainModel_interf{
    @Override
    public void loadDatas(final OnBatchingLoadCallback callback) {
        ...
        HttpClient.excute(builder, new HttpUtils.Callback() {
            ...
            public void onResponse(String response) {
                ResponseBatching responseBatching = JSON.parseObject(response,ResponseBatching.class);
                callback.onBatchingLoadSuccess(responseBatching);
            }
