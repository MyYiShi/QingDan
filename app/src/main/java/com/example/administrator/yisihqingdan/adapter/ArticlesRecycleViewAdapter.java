...
public class ArticlesRecycleViewAdapter extends BaseMainListRecycleViewAdapter<ResponseMainListData.DataBean.ArticlesBean> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        mHolder.textViewFrontSubtitle.setText(articlesBean.getSubtitle());
